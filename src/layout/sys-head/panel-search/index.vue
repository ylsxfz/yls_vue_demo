<template>
  <div class="panel-search" flex="dir:top">
    <div class="panel-search__input-group" flex-box="0" flex="dir:top main:center cross:center" @click.self="handlePanelClick">
      <sys-icon-svg class="panel-search__logo" name="sys-admin-text"/>
      <el-autocomplete
        ...
        @select="handleSelect">
        <sys-panel-search-item slot-scope="{ item }" :item="item"/>
      </el-autocomplete>
...
export default {
  ...
  components: {
    'sys-panel-search-item': () => import('./components/panel-search-item/index.vue')
  },
  data () {
    return {
      searchText: '',
