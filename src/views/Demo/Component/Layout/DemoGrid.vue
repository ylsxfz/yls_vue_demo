<template>
  <sys-container type="full" class="page">
   <sys-grid-layout
      v-bind="layout"
      ...
      <sys-grid-item
        ...
        <el-card shadow="never" class="page_card">
          ...
          <template v-if="item.i === '0'">
            <div class="sys-mb">拖拽卡片调整位置</div>
            <div class="sys-mb">拖拽卡片右下角的手柄调整卡片大小</div>
            <div class="sys-mb">在控制台打印出数据变化</div>
          </template>
        </el-card>
      </sys-grid-item>
    </sys-grid-layout>
...
Vue.component('sys-grid-layout', VueGridLayout.GridLayout)
Vue.component('sys-grid-item', VueGridLayout.GridItem)
export default {
  data () {
    return {
      layout: {
